	...
	<html lang='es'>
		...
		<body>
			...
			<form method='GET' action='registroR.php'>
				...
				<input type=text size='50' maxlength='15' name='usuario' placeholder='Máximo 15 caracteres' required/>
				<br/><br/>
				<label>Contraseña</label><br/>
				<input type='password' size='50' maxlength='30' name='contraseña' required/><br/>
